...
def load_models_and_scaler():
    try:
        ...
        gender_model = load_model(r"C:\Users\ROY\Documents\python_proj\Task3\Task3 models\gendertask3.h5")
        emotion_model = load_model(r"C:\Users\ROY\Documents\python_proj\Task3\Task3 models\emotiontask3.h5",custom_objects=custom_objects)
        age_model = load_model(r"C:\Users\ROY\Documents\python_proj\Task3\Task3 models\agetask3.h5")
        ...
        if uploaded_files:
            with st.spinner("Analyzing audio files."):
                for i, uploaded_file in enumerate(uploaded_files):
                    ...
                    #Checking if age is greater than 60 for emotion detection
                    if age > 60:
