...
def load_models():
    try:
        gender_model = load_model(r"C:\Users\ROY\Documents\python_proj\Task4\Task4 models\gendertask4.h5")
        age_model = load_model(r"C:\Users\ROY\Documents\python_proj\Task4\Task4 models\agetask4.h5")
        hairlength_model = load_model(r"C:\Users\ROY\Documents\python_proj\Task4\Task4 models\hairlengthtask4.h5")
...
def preprocess_gender_age_image(image):
    try:
        ...
        st.error(f"Error in gender and/or age preprocessing: {e}")
        return None
